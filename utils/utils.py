...
def parse_arguments():
    ...
    parser.add_argument('--prompt_input_path', type = str, help = "path to .md file with prompt")
    parser.add_argument('--input_debiased_data_path', type = str, help = "path to debiased dataset")
