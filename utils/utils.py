...
def parse_arguments():
    ...
    parser.add_argument('--embed_both_datasets', type = str, default = None, help = "variavel para execução do embedding dos textos. original indica que o conjunto de dados original será feito embedding, debiased indica que o conjunto de dados desinviesado será feito embedding, None aplica o embedding a ambos os datasets")
