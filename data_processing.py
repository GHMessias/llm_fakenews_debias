...
# gerar os 
if args.run_both_datasets == 'original' or args.run_both_datasets == None:
    ...
    for graph in graph_generator_list:
        edge_index = np.load(f'results/{args.actual_date}/original_graphs/edge_index_{graph}.npy')
        ...
        torch.save(graph_data, f'results/{args.actual_date}/original_graphs/graph_{graph}.pt')
        ...
        for s in range(args.benchmark_samples):
            ...
            torch.save(train_mask, f'results/{args.actual_date}/original_graphs/samples/train_mask_{s}.pt')
            torch.save(test_mask, f'results/{args.actual_date}/original_graphs/samples/test_mask_{s}.pt')
